...
Original file is located at
    https://colab.research.google.com/drive/1zUZE-Jo0ZmP4VxeHs8w_CM6Tlc3Xh6GC
...
normal_coef1=np.matmul(trans_x1,X1)

normal_vect1=np.matmul(trans_x1,Y1)
...
trans_x2 = np.transpose(X2)
normal_coef2=np.matmul(trans_x2,X2)

normal_vect2=np.matmul(trans_x2,Y2)
...
trans_x3 = np.transpose(X3)
normal_coef3=np.matmul(trans_x3,X3)

normal_vect3=np.matmul(trans_x3,Y3)
...
uran_period = 30687.15
pred_Uran=np.exp(beta3[0])* uran_period**beta3[1]

nept_period = 60190.03
pred_Nept=np.exp(beta3[0])* nept_period**beta3[1]
