...
Original file is located at
    https://colab.research.google.com/drive/1ontg7G2762Pd0Qouc1woYtZgbYDP2B1p
...
n_var1=2
print(jacobi1_method(n_var1))

n_var2=6  
print(jacobi1_method(n_var2))
...
n_var3=2
print(gs1_method(n_var3))

n_var4=4
print(gs1_method(n_var4))
...
def gs1_error(n):
  tru_vals = np.array([x_val, y_val])
  approx = np.array(gs1_method(n))
  return np.linalg.norm(tru_vals - approx)
...
def gs2_error(n): 
  tru_vals = np.array([x_val_2, y_val_2])
...
def gs3_iteration(x,y,z): 
    new_x = (2*y - 3*z - 8) / 5
    new_y = (-1*new_x + 4*z + 102) / 4
    new_z = (2*new_x + 2*new_y - 90) / 4
    return [new_x, new_y, new_z]

print(gs3_iteration(3, 5, 4))
